...
(function () {
    ...
    function readQuickOpts() {
        return {
            ...
            includeNonHtml:   $('smQuickIncludePdfImg') ? $('smQuickIncludePdfImg').checked : false,
            includeImages:    $('smQuickIncludeImages') ? $('smQuickIncludeImages').checked : false,
            includeVideo:     $('smQuickIncludeVideo') ? $('smQuickIncludeVideo').checked : false,
            includeNews:      $('smQuickIncludeNews') ? $('smQuickIncludeNews').checked : false,
        };
    }
    ...
    function readClientOpts() {
        return {
            ...
            includeNonHtml:     $('smClientIncludePdfImg') ? $('smClientIncludePdfImg').checked : false,
            includeImages:      $('smClientIncludeImages') ? $('smClientIncludeImages').checked : false,
            includeVideo:       $('smClientIncludeVideo') ? $('smClientIncludeVideo').checked : false,
            includeNews:        $('smClientIncludeNews') ? $('smClientIncludeNews').checked : false,
